...
<div class="col-md-5">
	<div class="panel info-box panel-white">
		<div class="panel-body">
			<div class="info-box-stats1">
				<span>Cost</span> 
				<span class="btn btn-primary waves-effect waves-button waves-red float-right" data-toggle="modal" data-target="#myModal">
...
<input type="text" id="area-hidden" name="" class="hidden">
