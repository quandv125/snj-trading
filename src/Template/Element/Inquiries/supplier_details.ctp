...
<div class="panel-body "> 
	<div role="tabpanel">
		<ul class="nav nav-tabs" role="tablist">
			...
			<li role="presentation" id="presentation2"><a href="#tab2" role="tab" data-toggle="tab"><?= __("Detail Inquiries"); ?></a></li>
		</ul>
		<div class="tab-content tab-content-lx">
			<div role="tabpanel" class="tab-pane active fade in" id="tab1">
				...
				<div class="col-md-5">
					<span class="col-md-6">
						<?= $this->Form->input('created',['disabled','label'=>'Inquiry Date','value'=>$inqSuppliers->inquiry['created']]) ?>
					</span>
					<span class="col-md-6">
						<?= $this->Form->input('supplier',['label' => 'Suppliers','disabled','value' => $inqSuppliers->supplier['name']]) ?>
					</span>
					<span class="col-md-6">
						<?= $this->Form->input('supplier_ref',['label' => 'Suppliers Ref','value' => $inqSuppliers->supplier_ref]) ?>
					</span>
					<span class="col-md-6">
						<?= $this->Form->input('supplier_pic_id',['label' => 'Suppliers Pics','options' => $supplier_pics,'default' => $inqSuppliers->supplier_pic['id']]) ?>
					</span>
					<span class="col-md-6">
						<?= $this->Form->input('total',['class'=>'supps-total-'.$inqSuppliers->id,'value' => number_format($total, 2)]) ?>
					</span>
					<span class="col-md-6">
						<?= $this->Form->input('subject',['value'=>'Spare Part']) ?>
					</span>
					<span class="col-md-6">
						<?= $this->Form->input('currency',['label'=>'Currency','options' => CURR ,'value' => $inqSuppliers->currency]) ?>
					</span>
				</div>
				<div class="col-md-5">
					<span class="col-md-6">
						<?= $this->Form->input('delivery_terms',['type'=>'textarea','value' => $inqSuppliers->delivery_terms]) ?>
					</span>
					<span class="col-md-6">
						<?= $this->Form->input('payment_terms',['type'=>'textarea','value' => $inqSuppliers->payment_terms]) ?>
					</span>
					<span class="col-md-12">
						<?= $this->Form->input('remark',['label' => 'Remark from supplier','type'=>'textarea','value' => $inqSuppliers->remark]) ?>
					</span>
				</div>
				<div class="col-md-1"></div>
