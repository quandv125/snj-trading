<tr>
    <td colspan="4"></td>
    <td class="text-center">$ <?php echo number_format($total_price->final_price, DECIMALS)?></td>
    <td></td>
</tr>
<?php foreach ($stocks as $stock): ?>
    <tr class="row-cz-<?= $str_rand?> cursor-pointer">
        ...
        <td class="text-center"><?= number_format($stock->final_price, DECIMALS)?></td>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
                                ...
                                <?php foreach ($stock->stock_products as $key => $StockProducts): ?>
                                    ...
                                    <tr class="stock_products_<?= $StockProducts->id?>">
                                        <th class="text-center"> <input tabindex="100<?= $key?>" type="checkbox" class="icheck-<?= $str_rand?> sp-chbox-<?= $stock->id;?>" spid="<?= $StockProducts->id?>" cid="<?= $key?>" id="input-100<?= $key?>" name="chbox-stock"></th>
