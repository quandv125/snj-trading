    ...
    <div class="hot-deal-slider5 simple-owl-slider slider-home5">
        ...
        <?php foreach ($products as $key => $product): ?>
            ...
            <div class="item-hotdeal">
                <div class="hotdeal-countdown5" data-date="12/15/2016"></div>
                <div class="product-thumb">
                     <?php if (!empty($product->images)): ?>
                    <a class="product-thumb-link" href="pages/products/<?= $product->id?>">
                        <?php echo $this->Html->image($product->images[0]['thumbnail'],['class'=>'first-thumb','width' => 230])  ?>
                        <?php echo $this->Html->image($product->images[0]['thumbnail'],['class'=>'second-thumb','width' => 230])  ?>
                    </a>
                <?php endif ?>
...
<div class="latest-new5">
    <div class="special-slider-header">
        <h2 class="title-special">latest</h2>
    </div>
