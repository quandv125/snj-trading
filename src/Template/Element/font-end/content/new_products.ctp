...
<div class="popular-cat-title">
    <ul>
        <li class="active"><a href="#new1" data-toggle="tab">new products 1</a></li>
        <li><a href="#best1" data-toggle="tab">new products 2</a></li>
        <li><a href="#pop1" data-toggle="tab">new products 3</a></li>
    </ul>
</div>
