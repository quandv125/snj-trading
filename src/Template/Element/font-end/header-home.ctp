		...
		<div class="container">
			<div class="row">
				<div class="col-md-2 col-sm-12 col-xs-12">
					<div class="logo5">
						<?= $this->Html->image('logo.png',['url'=>['controller'=> 'pages','action' => 'index'],'class'=>'img-responsive','width' => '100%']) ?>
					</div>
				</div>
				<div class="col-md-10 col-sm-12 col-xs-12" style="margin-top: 10px;">
					<div class="col-md-9 col-sm-8 col-xs-12">
						<div class="smart-search search-form3 search-form5">
							<?= $this->element('font-end/smart-search',['class' => 'smart-search']) ?>
						</div>
					</div>
						...
						<div class="wrap-cart-info3">
							<ul class="top-info top-info3">
								<li class="top-account has-child">
									<?= $this->element('font-end/top_accounts') ?>
								</li>
							...
							<?= $this->element('font-end/cart') ?>
						</div>
					</div>
					<div class="clearfix"></div>
					<div class="col-md-4 col-sm-4 col-xs-4">
						<span><?= $this->Html->image('flags/cal.png') ?></span>
						<span style="color: #ffffff;">
							<?php //echo $this->Html->link(__("Delivery all day of the year"),['controller'=>'pages','action'=>'accounts#exchange']) ?>
							<?= "Delivery all day of the year" ?>
						</span>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4">
						<span><?= $this->Html->image('flags/rocket.png') ?></span>
						<span style="color: #ffffff;"><?= __("Fast and accurate delivery service") ?> </span>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4">
						<span><?= $this->Html->image('flags/support.png') ?></span>
						<span style="color: #ffffff;"><?= __("Customer Service Professional") ?> </span>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-3 col-sm-3 col-xs-6 ">
				    <div class="category-dropdown hidden-category-dropdown">
				        <h2 class="title-category-dropdown"><span><?= __('Categories') ?></span></h2>
