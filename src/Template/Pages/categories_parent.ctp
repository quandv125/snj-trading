											...
											<div class="wapper-category">
												<div class="list-cat-mega-menu">
													<h2 class="title-cat-mega-menu"> 
														<?php //echo $this->Html->link($c->name, ['controller'=>'Pages','action'=>'categories', $id,$c->id]); ?> (<?php //echo count($c->products)?>)
													</h2>
													<?php// if (!empty($c->children)): ?>
													<ul>
														<?php// foreach ($c->children as $key => $children): ?>
															<li><?php //echo $this->Html->link($children->name, ['controller'=>'Pages','action'=>'categories', $id,$children->id]); ?> (<?php //echo count($children->products)?>)
															</li>
														<?php// endforeach ?>
													</ul>
													<?php// endif ?>
