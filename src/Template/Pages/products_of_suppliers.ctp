       ...
       <div class="main-content-shop ">
            ...
            <table id="datatable" class="display" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="click text-center"><?= $this->Html->link(str_pad($product->sku, ZEROFILL, ZERO, STR_PAD_LEFT), ['controller' => 'Pages', 'action' => 'products', $product->id]); ?></td>
                        <td class="click text-center"><?= $this->Html->link( $product->product_name, ['controller' => 'Pages', 'action' => 'products', $product->id]); ?></td>
                        <td class="click text-center"><?= ($product->origin); ?></td>
                        <td class="click text-center"><?= $product->type_model; ?></td>
                        ...
                        <td class="text-center">
                             <?php echo $this->Html->link('<i class="fa fa-pencil"></i>',['controller'=>'Products','action' => 'SupplierEditProduct',$product->id],['class'=>'btn btn-success','escape' => false]) ?>
