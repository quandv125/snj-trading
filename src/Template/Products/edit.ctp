					...
					<div role="tabpanel">
						...
						<ul class="nav nav-tabs nav-justified" role="tablist">
							<li role="presentation" class="active">
								<a href="#tabs1" role="tab" data-toggle="tab"><?php echo __("Products") ?></a>
							</li>
							<li role="presentation">
								<a href="#tabs2" role="tab" data-toggle="tab"><?php echo __("Infomations") ?></a>
							</li>
							<li role="presentation">
								<a href="#tabs3" role="tab" data-toggle="tab"><?php echo __("Descriptions"); ?></a>
							</li>
							<li role="presentation">
								<a href="#tabs4" role="tab" data-toggle="tab"><?php echo __("Image") ?></a>
							</li>
						</ul>
						<!-- Tab panes -->
						<div class="tab-content tab-content-bg-none">
							<div role="tabpanel" class="tab-pane active fade in" id="tabs1">
								<div class="col-lg-6 col-md-6">
									<?= $this->Form->input('sku',['class'=>'sku','value' => $product->sku,'placeholder' => 'Product Code','label' => 'Product Code']); ?>
									<?= $this->Form->input('product_name',['class' => 'product_name','value' => $product->product_name,'placeholder' => 'Name']); ?>
									<?= $this->Form->input('retail_price',['class' => 'currency','placeholder' => 'USD','value'=>number_format($product->retail_price, 0, '.', ',')]); ?>
								...
								<div class="col-lg-6 col-md-6">
									...
									<?= $this->Form->input('categorie_id', [
										'label'=>__('Category'), 'class' => 'categorie_id js-states', 'value' => $product->categorie_id, 'id' => 'PCategorie_Id', 'append' => [
									...
									<?= $this->Form->input('supplier_id',[
										'class' => 'supplier_id', 'value' => $product->supplier_id, 'id' => 'PSupplier_Id', 'append' => [
