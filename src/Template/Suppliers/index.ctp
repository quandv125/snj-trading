                            ...
                            <tbody id="suppliers-details">
                                <?php foreach ($suppliers as $suppliers): ?>
                                     <tr class="row-cz cursor-pointer">
                                        ...
                                        <td class="text-center"><?= ($suppliers->code) ?></td>
                                            ...
                                            <div role="tabpanel">
                                                ...
                                                <ul class="nav nav-tabs nav-justified" role="tablist">
                                                    ...
                                                    <li role="presentation">
                                                        <a href="#tab2<?= $suppliers->id?>" class="bold" role="tab" data-toggle="tab"><?php echo __("Stock card"); ?></a>
                                                    </li>
                                                    <li role="presentation">
                                                        <a href="#tab3<?= $suppliers->id?>" class="bold" role="tab" data-toggle="tab"><?php echo __("Stock Level") ?></a>
                                                    </li>
                                                    <li role="presentation">
                                                        <a href="#tab4<?= $suppliers->id?>" class="bold" role="tab" data-toggle="tab"><?php echo __("Image") ?></a>
                                                    </li>
                                                </ul>
                                                <!-- Tab panes -->
                                                    ...
                                                    <div role="tabpanel" class="tab-pane active fade in" id="tab1<?= $suppliers->id?>">
                                                        ...
                                                        <div class="content">
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                ...
                                                                <!-- Modal -->
                                                                <?= $this->element('suppliers/index_edit',['supplier'=> $suppliers]);?>
                                                           
                                                                <?= $this->Form->postLink(__('<i class="fa fa-trash"></i> Delete'),
                                                                    ['action' => 'delete', $suppliers->id],
                                                                    ['confirm' => __('Are you sure you want to delete # {0}?', $suppliers->id),'class' => 'btn btn-danger btn-addon m-b-sm waves-effect waves-button waves-red', 'escape' => false])?>
                                                            </div>
                                                        </div>
                                                    </div>
