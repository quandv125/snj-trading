...
<div class="row">
    ...
    <div class="col-md-9 col-sm-8 col-xs-12 ">
       ...
       <!-- <div>
            ...
            <?= $this->Form->create(Null,['url'=>['controller'=>'Users','action'=>'changepassword',$id],'class'=>'form-my-account']) ?>
            <?= $this->Form->input('password',['label' => false,'placeholder'=>"New Password *"]) ?>
            <?= $this->Form->input('cpassword',['type'=>'password','label' => false,'placeholder'=>"Comfirm Password *"]) ?>
